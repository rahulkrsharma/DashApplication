...
@NgModule({
  declarations: [MydashboardComponent,ProjectpricingComponent,TeamComponent,AdminComponent, CreateprojectpricingComponent, ProfileComponent, ProjectsComponent, PricingfilesComponent, MyDashBreadcrumbComponent, UserAdminComponent, ProjectsAdminComponent, SystemAdminComponent, SelesforecastComponent, ScheduleComponent,
  ],
  imports: [
    CommonModule,
