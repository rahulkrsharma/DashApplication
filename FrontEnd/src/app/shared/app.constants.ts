export class AppConstants {
    ...
    public static get scheduleDetailsUrl():string { return this.baseUrl + '/ProjectPricing/FetchWeeklyAllocation'};

    public static get teamAllocationsUrl():string { return this.baseUrl + '/ProjectPricing/FetchTeamAllocation'};

    public static get utilisationbylevelUrl():string { return this.baseUrl + '/ProjectPricing/UlitstationByLevels'};
    ...
    public static get deletePricingUrl():string { return this.baseUrl + '/ProjectPricing/DeletePricing'};
