...
import { countries, locationList } from '../../../../app/data/country-data-store';
...
export class RegisterComponent implements OnInit {
  ...
  public locationList:any = locationList; 
  ...
  onSubmit() {
    ...
    this.authService.register(this.registerForm.value).subscribe(
      result=>{
        ...
        {
          //this.OnSuccess('We have sent an email to activate your account');
