...
export class ListPageHeaderComponent implements OnInit {
  ...
  @Input()  itemOptionsOrders = [{ label: 'Created Date', value: 'CreatedDate' },{ label: 'Client Name', value: 'ClientName' }, { label: 'Project Name', value: 'ProjectName' }, { label: 'Levant Lead', value: 'LevantLead' }, { label: 'Location', value: 'Location' }, { label: 'StartDate', value: 'StartDate' }, { label: 'Status', value: 'Status' }];
